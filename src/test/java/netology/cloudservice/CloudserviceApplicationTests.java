...
import netology.cloudservice.dto.FileNameInRequest;
...
//        userRepository.save(new UserEntity("user1", "password1"));
//        final HttpHeaders headers = new HttpHeaders();
//        headers.set("Content-Type", "application/json");
//
//        final LoginInRequest operation = new LoginInRequest("user1", "password");
